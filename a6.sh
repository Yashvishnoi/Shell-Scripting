...
if  [ ! -f  "/home/yash/Desktop/Scripting/forbidden_commands.txt" ]; then    	echo "ERROR: The file /opt/forbidden_commands.txt does not exist" >&2; exit 1;
fi
...
function validate_commands { 
   cat /home/yash/Desktop/Scripting/forbidden_commands.txt | while read command; do   
